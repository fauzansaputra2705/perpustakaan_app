...
<template>
    ...
    <div v-if="props.nameMenu == 'petugas'">
        <Link
            v-show="permission.includes('view data petugas')"
            :href="route('master.petugas.index')"
            class="sidebar-link"
            :class="{ active: route().current('master.petugas.index') }"
            aria-expanded="false"
        >
            <div v-if="props.isSubMenu" class="round-16 d-flex align-items-center justify-content-center">
                <i class="ti ti-circle"></i>
    ...
    <div v-if="props.nameMenu == 'anggota'">
        <Link
            v-show="permission.includes('view data anggota')"
            :href="route('master.anggota.index')"
            class="sidebar-link"
            :class="{ active: route().current('master.anggota.index') }"
            aria-expanded="false"
        >
            <div v-if="props.isSubMenu" class="round-16 d-flex align-items-center justify-content-center">
                <i class="ti ti-circle"></i>
